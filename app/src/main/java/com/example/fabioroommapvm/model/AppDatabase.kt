    ...
    companion object {
        ...
        private suspend fun datosIniciales(tipoMarcadorDao: TipoMarcadorDao, marcadorDao: MarcadorDao) {
            ...
            val marcadores = listOf(
                ...
                Marcador(tituloMarcador = "Playa Blanca", coordenadaX = 28.869973, coordenadaY = -13.861702, idTipoMarcador = tiposFromDbUpdated[2].idTipoMarcador),
                ...
                Marcador(tituloMarcador = "Playa Francesa - La Graciosa", coordenadaX = 29.274952, coordenadaY = -13.506243, idTipoMarcador = tiposFromDbUpdated[2].idTipoMarcador),
